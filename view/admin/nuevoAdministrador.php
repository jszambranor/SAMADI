...
require_once '../../controller/ClassControllerAdministrador.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $Correo = $_POST['mail'];
  $objControllerPersona = new ControllerAdministrador();
  $mensaje = $objControllerPersona->insert_Administrador($Cedula,$Apellidos,$Nombres,$Correo);
  //echo $mensaje;
}else {
    ...
    <main>
        <div class="section container">
            <div class="row">
              <div class="header">
                <div class="tittle">
                  <span>REGISTRO DE NUEVO ADMINISTRADOR</span>
                </div>
              </div>
                <form class="col s12" method="POST" action="./nuevoAdministrador.php">
