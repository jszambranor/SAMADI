                ...
                <div class="contenido">
                    <div class="card small">
                        ...
                        <div class="card-content">
                            ...
                            <p id="link"><a href="./agregar_estudiante.php">Estudiantes</a></p>
                        </div>
                ...
                <div class="contenido">
                    <div class="card small">
                        ...
                        <div class="card-content">
                            ...
                            <p id="link"><a href="agregar_gestor-contenido.php">Gestores de Contenido</a></p>
                        </div>
                        <div class="card-reveal">
                            <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
                            <p>Here is some more information about this product that is only revealed once clicked on.</p>
                ...
                <div class="contenido">
                    <div class="card small">
                        ...
                        <div class="card-content">
                            ...
                            <p id="link"><a href="agregar_administradores.php">Administradores</a></p>
                        </div>
                        <div class="card-reveal">
